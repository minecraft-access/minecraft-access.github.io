...
You can find some good tutorials in [this page]("https://docs.mcaccess.org/good-resources#tutorial-resources").
...
If you have any questions about installing, please read the [set-up guide](https://docs.mcaccess.org/setup/basic).
...
If you have any questions about this mod, please read the [documentation](https://docs.mcaccess.org).
...
See the [I18N Fallback Mechanism](https://docs.mcaccess.org/features#i18n-fallback-mechanism) feature.
...
I assume you have taken a look at the [setup guide](https://docs.mcaccess.org/setup/basic).
...
please refer to [this section](https://docs.mcaccess.org/setup/basic#update-the-game-and-mods) in the basic setup guide.
